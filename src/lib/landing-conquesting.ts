...
const CONTENT: Record<Locale, LandingContent> = {
  es: {
    ...
    comparison: [
      ...
      { feature: "Laboratorio en la misma clínica", clinic: true, others: false },
    ...
    offerings: [
      ...
      "Laboratorio clínico con toma de muestra en la clínica",
  ...
  en: {
    ...
    comparison: [
      ...
      { feature: "Lab work at the same clinic", clinic: true, others: false },
    ...
    offerings: [
      ...
      "Clinical lab with in-clinic sample collection",
