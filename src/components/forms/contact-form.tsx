...
export function ContactForm({
  ...
  const {
    ...
    // error, actualiza en vivo mientras el usuario corrige.
    mode: "onTouched",
    defaultValues: {
      name: "",
      phone: "",
  ...
  if (status === "success") {
    return (
      <div className="flex flex-col items-center rounded-3xl border border-blue-light bg-white p-10 text-center shadow-sm">
  ...
  return (
    <form
      ...
      noValidate
      className="rounded-3xl border border-blue-light bg-white p-6 shadow-sm sm:p-8"
    >
      {/* Honeypot oculto */}
      <input
        type="text"
