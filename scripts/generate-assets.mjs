...
const bg = Buffer.from(`<svg xmlns="http://www.w3.org/2000/svg" width="1200" height="630" viewBox="0 0 1200 630">
  ...
  <text x="540" y="362" font-family="Arial, Helvetica, sans-serif" font-size="36" font-weight="700" fill="#7fe3ec">Houston, TX</text>
  <text x="120" y="560" font-family="Arial, Helvetica, sans-serif" font-size="30" fill="#cfe2f6">Atención médica 100% en español · Sin cita · Para pacientes sin seguro</text>
</svg>`);
await sharp(bg)
